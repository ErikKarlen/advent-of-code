...
fn apply_operation(operator: &Operator, left: u64, right: u64) -> u64
{
    match operator {
        ...
        Operator::Con => format!("{}{}", left, right).parse::<u64>().unwrap(),
    }
}
...
fn main() {
    ...
    println!("The total calibration result from the equations using our knowledge of elephant hiding spots is {total_calibration_result}.");
}