...
if __name__ == "__main__":
    print(f"The sum of the lengths of the shortest paths between every pair of galaxy with the new rules is {solution(sys.argv[1])}.")
